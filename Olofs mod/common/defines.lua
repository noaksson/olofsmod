...
NDiplomacy = {
	...
	MAX_DUCHIES_LEGALLY_HELD = 4,				-- Max duchies that a king or above can hold before vassals start getting angry
	...
	PRESTIGE_OPINION_MAX = 25,					-- Max opinion impact of prestige (positive OR negative)
...
NCharacter = {
	...
	CHANGE_SUCC_LAW_YEARS = 7,						-- Rulers must have reigned this long before they can change succession laws
	...
	RAISED_TROOPS_VASSAL_OPINION_DAYS = 93,			-- After 93 days of having their troops raised, vassals will get -1 opinion more of you
...
NMilitary = {
	...
	MAX_LEVY_RAISE_OPINION_THRESHOLD = 85,			-- Above this opinion value you'll get the max amount of troops possible
	...
	DIFFERENT_RELIGIONGROUP_SUPPLY_PENALTY = -0.4,	-- Only 60% supply in provinces with different religios group
	...
	RETINUE_FROM_REALMSIZE = 8.0,
	RETINUE_INCREASE_PER_TECH = 3.5,
